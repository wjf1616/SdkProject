...
public class NewVersionBattleMailContents
{
	...
	private int 					buildingDefenceLoss;
	private boolean					noAddSCForMax;
	private boolean					noAddSCForSameServer;
	private ExtraArmyInfoParams		extraArmyInfo;

	private List<String>			defskills;
	private List<String>			attskills;

	private List<NewVersionBattleReportsParams>			battleReports;//新战斗

	public List<NewVersionFormationParams> getFormation() {
		return formation;
	}

	public void setFormation(List<NewVersionFormationParams> formation) {
	...
	private List<NewVersionFormationParams>			formation;
	...
	public int getBuildingDefenceLoss() {
		return buildingDefenceLoss;
	}

	public void setBuildingDefenceLoss(int buildingDefenceLoss) {
		this.buildingDefenceLoss = buildingDefenceLoss;
	}

	public boolean isNoAddSCForMax() {
		return noAddSCForMax;
	}

	public void setNoAddSCForMax(boolean noAddSCForMax) {
		this.noAddSCForMax = noAddSCForMax;
	}

	public boolean isNoAddSCForSameServer() {
		return noAddSCForSameServer;
	}

	public void setNoAddSCForSameServer(boolean noAddSCForSameServer) {
		this.noAddSCForSameServer = noAddSCForSameServer;
	}

	public ExtraArmyInfoParams getExtraArmyInfo() {
		return extraArmyInfo;
	}

	public void setExtraArmyInfo(ExtraArmyInfoParams extraArmyInfo) {
		this.extraArmyInfo = extraArmyInfo;
	}
	...
	public List<NewVersionBattleReportsParams> getBattleReports() {
		return battleReports;
	}

	public void setBattleReports(List<NewVersionBattleReportsParams> battleReports) {
